...
/**
 * Ignore all butt input when true. This should be used on sit complete to let the final response sound play uninterrupted and then to false when the sound ends. 
 * DO NOT set to true without a way to set to false without using butt events. 
 * @type {Boolean}
 */
